...
<div style="background-color: white; margin-left: 80px; margin-right: 80px; height: 800px;">
	...
	<h1 style="color: red; margin-left: 50px;">USER LOGIN PAGE</h1><br /><br />
	<table>
	<tr>
...
$email = $_POST['email'];
 ...
 $result = mysqli_query($conn,"select *from register where email = '$email' and password = '$password'")or die("failed to query databases".mysqli_error());
